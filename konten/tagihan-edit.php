                        ...
                        <div class="col-md-4">
                                ...
                                ?>
                                  ...
                                  <div class="alert alert-warning mt-3 text-center text-bold" role="alert" >
                                    Perhatian!!!<br>
                                    Data Tagihan yang bisa diubah hanya tagihan yang belum memiliki riwayat pembayaran, bila ingin mengubah data tersebut harap menghapus pembayaran terlebih dahulu
                                  </div>
                                  <?php
                                  } else {
