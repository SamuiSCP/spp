                    ...
                    <table id="example1" class="table table-hover table-sm">
                        ...
                        ?>
                            <tr class="<?= $warna; ?>">
                                ...
                                <td>
                                    <!-- Tombol Informasi     -->
                                   <a title="Detail Tagihan Siswa" href="index.php?p=tagihan-info-siswa&id_tagihan=<?= $kolom['id_tagihan']; ?>"><i style="color : white;" class="fas fa-search"></i></a>
                    ...
                    <table id="example1" class="table table-hover table-sm">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                   <!-- Tombol Informasi     -->
                                   <a title="Detail Pembayaran Siswa" href="index.php?p=bayar-alokasi-siswa&id_bayar=<?= $kolom['id_bayar']; ?>"><i class="fas fa-search"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
                    </table>
